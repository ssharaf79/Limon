...
// Searches for any new crash logs and uploads them to the server.
- (BOOL)reportIfCrashSilently;

// Clear any crash logs that we might send.
- (void)clearAnyPendingCrashLogs;
